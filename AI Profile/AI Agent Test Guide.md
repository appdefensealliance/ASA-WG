...
1. [Model & Data Integrity](#1-model--data-integrity)
   ...
   * 1.1 [Adversarial Training and Testing](#11-adversarial-training-and-testing)
       ...
       * 1.1.1 [Testing for Evasion Attacks (AITG-MOD-01)](#111-testing-for-evasion-attacks-aitg-mod-01)

       * 1.1.2 [Jailbreak Resistance Testing](#112-jailbreak-resistance-testing)

       * 1.1.3 [Minimize hazardous responses](#113-minimize-hazardous-responses)

   * 1.2 [Model and Data Access Controls](#12-model-and-data-access-controls)

       * 1.2.1 [Testing for Runtime Exfiltration (AITG-DAT-02)](#121-testing-for-runtime-exfiltration-aitg-dat-02)

   * 1.3 [Memory and Retrieval Store Integrity](#13-memory-and-retrieval-store-integrity)

       * 1.3.1 [Memory Poisoning Resistance](#131-memory-poisoning-resistance)

       * 1.3.2 [Retrieval / Vector Store Integrity (AITG-APP-08)](#132-retrieval--vector-store-integrity-aitg-app-08)

2. [Agent Governance](#2-agent-governance)

   * 2.1 [Agent Permissions](#21-agent-permissions)

       * 2.1.1 [Testing for Agentic Behavior Limits (AITG-APP-06)](#211-testing-for-agentic-behavior-limits-aitg-app-06)

       * 2.1.2 [Testing for Sandbox Containment](#212-testing-for-sandbox-containment)

       * 2.1.3 [Testing for Loop Termination and Execution Bounds](#213-testing-for-loop-termination-and-execution-bounds)

   * 2.2 [Agent User Control](#22-agent-user-control)

       * 2.2.1 [Testing for Over-Reliance on AI (AITG-APP-13)](#221-testing-for-over-reliance-on-ai-aitg-app-13)

       * 2.2.2 [Human in the Loop controls for AI Tools](#222-human-in-the-loop-controls-for-ai-tools)

       * 2.2.3 [Testing for Tool-Initiated Elicitation Conformance (MCP)](#223-testing-for-tool-initiated-elicitation-conformance-mcp)

   * 2.3 [Agent Observability](#23-agent-observability)

       * 2.3.1 [Testing for Explainability and Interpretability (AITG-APP-14)](#231-testing-for-explainability-and-interpretability-aitg-app-14)

       * 2.3.2 [Testing for Capability Misuse (AITG-INF-04)](#232-testing-for-capability-misuse-aitg-inf-04)

   * 2.4 [Agent-Tool Interface Conformance](#24-agent-tool-interface-conformance)

       * 2.4.1 [Verifiable Identity Forwarding](#241-verifiable-identity-forwarding)

3. [Input/Output Security](#3-inputoutput-security)

   * 3.1 [Input Validation and Sanitization](#31-input-validation-and-sanitization)

       * 3.1.1 [Testing for Prompt Injection (AITG-APP-01)](#311-testing-for-prompt-injection-aitg-app-01)

       * 3.1.2 [Testing for Indirect Prompt Injection (AITG-APP-02)](#312-testing-for-indirect-prompt-injection-aitg-app-02)

       * 3.1.3 [Adversarial / Red-Team Testing](#313-adversarial--red-team-testing)

   * 3.2 [Output Validation and Sanitization](#32-output-validation-and-sanitization)

       * 3.2.1 [Testing for Unsafe Outputs (AITG-APP-05)](#321-testing-for-unsafe-outputs-aitg-app-05)

       * 3.2.2 [Testing for Prompt Disclosure (AITG-APP-07)](#322-testing-for-prompt-disclosure-aitg-app-07)

       * 3.2.3 [Testing for Hallucinated References (AITG-APP-11)](#323-testing-for-hallucinated-references-aitg-app-11)

   * 3.3 [Orchestrator and Route Integrity](#33-orchestrator-and-route-integrity)

       * 3.3.1 [Testing for Plugin Boundary Violations (AITG-INF-03)](#331-testing-for-plugin-boundary-violations-aitg-inf-03)
...
4. [Infrastructure & Resource Management](#4-infrastructure--resource-management)
   ...
   * 4.1 [Application Access and Resource Management](#41-application-access-and-resource-management)
       ...
       * 4.1.1 [Testing for Resource Exhaustion (AITG-INF-02)](#411-testing-for-resource-exhaustion-aitg-inf-02)

   * 4.2 [Incident Response Management](#42-incident-response-management)

       * 4.2.1 [Security Reporting Routing](#421-security-reporting-routing)

       * 4.2.2 [User Reporting Mechanism for AI Responses](#422-user-reporting-mechanism-for-ai-responses)
...
5. [Privacy & User Trust](#5-privacy--user-trust)
   ...
   * 5.1 [Privacy Enhancing Technologies for Inference](#51-privacy-enhancing-technologies-for-inference)
       ...
       * 5.1.1 [Testing for Sensitive Data Leak (AITG-APP-03)](#511-testing-for-sensitive-data-leak-aitg-app-03)

       * 5.1.2 [Testing for Input Leakage (AITG-APP-04)](#512-testing-for-input-leakage-aitg-app-04)

   * 5.2 [User Transparency, Control and Data Management](#52-user-transparency-control-and-data-management)

       * 5.2.1 [Testing for Data Minimization & Consent (AITG-DAT-05)](#521-testing-for-data-minimization--consent-aitg-dat-05)

       * 5.2.2 [Model and Agent Transparency (Model Card)](#522-model-and-agent-transparency-model-card)
...
6. [AI Tool Interface](#6-ai-tool-interface)
   ...
   * 6.1 [AI Tool Authentication and Session Security](#61-ai-tool-authentication-and-session-security)
       ...
       * 6.1.1 [Mandatory Client-Server Transport Authentication](#611-mandatory-client-server-transport-authentication)

       * 6.1.2 [Mandatory Cryptographic Validation of User Context](#612-mandatory-cryptographic-validation-of-user-context)

       * 6.1.3 [Message Freshness and Session Binding](#613-message-freshness-and-session-binding)

       * 6.1.4 [Strict Redirect URI and State Validation](#614-strict-redirect-uri-and-state-validation)

       * 6.1.5 [Mandatory Proof Key for Code Exchange (PKCE)](#615-mandatory-proof-key-for-code-exchange-pkce)

   * 6.2 [Tool Use Sanitization](#62-tool-use-sanitization)

       * 6.2.1 [Testing for Tool Description Metadata Sanitization](#621-testing-for-tool-description-metadata-sanitization)

       * 6.2.2 [Testing for LLM Control Tokens and Metadata Sanitization](#622-testing-for-llm-control-tokens-and-metadata-sanitization)
